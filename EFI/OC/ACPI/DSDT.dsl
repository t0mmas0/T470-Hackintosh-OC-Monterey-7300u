 ...
 *
 * Disassembly of DSDT.aml, Tue Nov 27 16:11:26 2018
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS3, 0x01)
    Name (SS4, 0x01)
    OperationRegion (GNVS, SystemMemory, 0x7FF57000, 0x072C)
    ...
    OperationRegion (MNVS, SystemMemory, 0x7FF68018, 0x1000)
